...
-- Tiempo de generación: 13-06-2023 a las 13:22:17
...
INSERT INTO `Comentario` (`id`, `id_usuario`, `id_cientifico`, `fecha`, `texto`, `moderado`) VALUES
(1, 1, 1, '2023-06-12 15:00:12', 'Definitivamente es un cientifico', 0),
(2, 2, 1, '2023-06-12 15:00:12', '5mentarios', 0),
(3, 3, 1, '2023-06-12 15:00:12', 'Pero ese no es el nombre de una plaza?', 0),
(4, 4, 1, '2023-06-12 15:00:12', 'Hola mundo!', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `HashtagCientifico`
--
...
--
-- Volcado de datos para la tabla `HashtagCientifico`
--

INSERT INTO `HashtagCientifico` (`id_cientifico`, `nombre`) VALUES
(1, 'historico'),
(1, 'relatividad'),
(2, 'física'),
(2, 'nuclear');
...
INSERT INTO `Usuario` (`id`, `nombre`, `email`, `pwd`, `tipo`) VALUES
(1, 'Usuario1', 'usuario1@example.com', '$2y$10$IJ58dJuoYY5iw9mutCj4nOklDSCH4ZeF61gef5CqfDlaOlDO1vUMm', 'Usuario'),
(2, 'Moderador2', 'moderador2@example.com', '$2y$10$ibkuNzKGYzsf6FKFBEw8D.ulZpgwWU8kcf8eK5f2IXgTbRGOonvi2', 'Moderador'),
(3, 'ElGestor3', 'gestor3@example.com', '$2y$10$mTtmyC/anf3KyKgkHgLdCOlq7X9Yipsn7xf3/6kROiGaayzzogRHG', 'Gestor'),
(4, 'ElSuperUsuario', 'elsuperusuario@example.com', '$2y$10$3jWXkxzJQfqJ67OYVEWI2O5veEMS.PfOC/5cjVnCabDfLL781Fz1i', 'Administrador');
...
--
-- Indices de la tabla `HashtagCientifico`
--
ALTER TABLE `HashtagCientifico`
  ADD PRIMARY KEY (`id_cientifico`,`nombre`);
...
--
-- Filtros para la tabla `HashtagCientifico`
--
ALTER TABLE `HashtagCientifico`
  ADD CONSTRAINT `hashtagcientifico_ibfk_1` FOREIGN KEY (`id_cientifico`) REFERENCES `Cientifico` (`id`);
...
--
ALTER TABLE `Usuario`
  ADD CONSTRAINT `usuario_ibfk_1` FOREIGN KEY (`tipo`) REFERENCES `TipoUsuario` (`tipo`);
COMMIT;
